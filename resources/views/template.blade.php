...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Sistema VB</a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{ route('venda_cadastro') }}">Vendas</a>
 	...
 	<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{ route('cliente_listar') }}">Relatório de Clientes</a>
          <a class="dropdown-item" href="{{ route('venda_listar') }}">Relatório de Vendas</a>
        </div>
      </li>
       <li class="nav-item">
